...
type Message struct {
	...
	FromUserId string `boil:"fromUserId" json:"fromUserId" toml:"fromUserId" yaml:"fromUserId"`
	ToUserId   string `boil:"toUserId" json:"toUserId" toml:"toUserId" yaml:"toUserId"`
...
var MessageWhere = struct {
	...
	FromUserId: whereHelperstring{field: "\"Message\".\"fromUserId\""},
	ToUserId:   whereHelperstring{field: "\"Message\".\"toUserId\""},
}

// MessageRels is where relationship names are stored.
var MessageRels = struct {
	ToUserIdUser   string
	FromUserIdUser string
}{
	ToUserIdUser:   "ToUserIdUser",
	FromUserIdUser: "FromUserIdUser",
}

// messageR is where relationships are stored.
type messageR struct {
	ToUserIdUser   *User `boil:"ToUserIdUser" json:"ToUserIdUser" toml:"ToUserIdUser" yaml:"ToUserIdUser"`
	FromUserIdUser *User `boil:"FromUserIdUser" json:"FromUserIdUser" toml:"FromUserIdUser" yaml:"FromUserIdUser"`
}
...
var (
	messageAllColumns            = []string{"id", "text", "fromUserId", "toUserId"}
	messageColumnsWithoutDefault = []string{"id", "text", "fromUserId", "toUserId"}
...
// ToUserIdUser pointed to by the foreign key.
func (o *Message) ToUserIdUser(mods ...qm.QueryMod) userQuery {
...
// FromUserIdUser pointed to by the foreign key.
func (o *Message) FromUserIdUser(mods ...qm.QueryMod) userQuery {
	queryMods := []qm.QueryMod{
...
// LoadToUserIdUser allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for an N-1 relationship.
func (messageL) LoadToUserIdUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeMessage interface{}, mods queries.Applicator) error {
	var slice []*Message
	var object *Message
	...
	if singular {
		...
		object.R.ToUserIdUser = foreign
		if foreign.R == nil {
			foreign.R = &userR{}
		}
		foreign.R.ToUserIdMessages = append(foreign.R.ToUserIdMessages, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.ToUserId == foreign.ID {
				local.R.ToUserIdUser = foreign
				if foreign.R == nil {
					foreign.R = &userR{}
				}
				foreign.R.ToUserIdMessages = append(foreign.R.ToUserIdMessages, local)
				break
			}
		}
	}
...
// LoadFromUserIdUser allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for an N-1 relationship.
func (messageL) LoadFromUserIdUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeMessage interface{}, mods queries.Applicator) error {
	var slice []*Message
	var object *Message
	...
	if singular {
		foreign := resultSlice[0]
		object.R.FromUserIdUser = foreign
		if foreign.R == nil {
			foreign.R = &userR{}
		}
		foreign.R.FromUserIdMessages = append(foreign.R.FromUserIdMessages, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.FromUserId == foreign.ID {
				local.R.FromUserIdUser = foreign
				if foreign.R == nil {
					foreign.R = &userR{}
				}
				foreign.R.FromUserIdMessages = append(foreign.R.FromUserIdMessages, local)
				break
			}
		}
	}
...
// SetToUserIdUser of the message to the related item.
// Sets o.R.ToUserIdUser to related.
// Adds o to related.R.ToUserIdMessages.
func (o *Message) SetToUserIdUser(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	var err error
	if insert {
	...
	if o.R == nil {
		o.R = &messageR{
			ToUserIdUser: related,
		}
	} else {
		o.R.ToUserIdUser = related
	}

	if related.R == nil {
		related.R = &userR{
			ToUserIdMessages: MessageSlice{o},
		}
	} else {
		related.R.ToUserIdMessages = append(related.R.ToUserIdMessages, o)
	}

	return nil
}

// SetFromUserIdUser of the message to the related item.
// Sets o.R.FromUserIdUser to related.
// Adds o to related.R.FromUserIdMessages.
func (o *Message) SetFromUserIdUser(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
	...
	if o.R == nil {
		o.R = &messageR{
			FromUserIdUser: related,
		}
	} else {
		o.R.FromUserIdUser = related
	}

	if related.R == nil {
		related.R = &userR{
			FromUserIdMessages: MessageSlice{o},
		}
	} else {
		related.R.FromUserIdMessages = append(related.R.FromUserIdMessages, o)
	}
