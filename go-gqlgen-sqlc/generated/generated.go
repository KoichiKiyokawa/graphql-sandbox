...
type ComplexityRoot struct {
	...
	Query struct {
		...
		User  func(childComplexity int, id scalar.UUID) int
...
type QueryResolver interface {
	User(ctx context.Context, id scalar.UUID) (*db.User, error)
	Users(ctx context.Context) ([]*db.User, error)
	Posts(ctx context.Context, limit *int) ([]*db.Post, error)
}
...
type UserResolver interface {
	...
	PostCount(ctx context.Context, obj *db.User) (int, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.user":
		...
		return e.complexity.Query.User(childComplexity, args["id"].(scalar.UUID)), true
	...
	case "User.postCount":
		if e.complexity.User.PostCount == nil {
			break
		}

		return e.complexity.User.PostCount(childComplexity), true
...
func (ec *executionContext) fieldContext_Mutation_createUser(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			...
			case "postCount":
				return ec.fieldContext_User_postCount(ctx, field)
			}
...
func (ec *executionContext) _Query_user(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().User(rctx, fc.Args["id"].(scalar.UUID))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	res := resTmp.(*db.User)
	fc.Result = res
	return ec.marshalOUser2ᚖgoᚑgqlgenᚑsqlcᚋdbᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_users(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*db.User)
	fc.Result = res
	return ec.marshalNUser2ᚕᚖgoᚑgqlgenᚑsqlcᚋdbᚐUserᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _User_postCount(ctx context.Context, field graphql.CollectedField, obj *db.User) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_User_postCount(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.User().PostCount(rctx, obj)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) fieldContext_User_postCount(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "User",
		Field:      field,
		IsMethod:   true,
	...
	for i, field := range fields {
		...
		case "postCount":
			...
			innerFunc := func(ctx context.Context) (res graphql.Marshaler) {
				...
				res = ec._User_postCount(ctx, field, obj)
				if res == graphql.Null {
					atomic.AddUint32(&invalids, 1)
				}
				return res
...
func (ec *executionContext) marshalNUser2ᚕᚖgoᚑgqlgenᚑsqlcᚋdbᚐUserᚄ(ctx context.Context, sel ast.SelectionSet, v []*db.User) graphql.Marshaler {
	ret := make(graphql.Array, len(v))
	var wg sync.WaitGroup
	isLen1 := len(v) == 1
	if !isLen1 {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNUser2ᚖgoᚑgqlgenᚑsqlcᚋdbᚐUser(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalOUser2ᚖgoᚑgqlgenᚑsqlcᚋdbᚐUser(ctx context.Context, sel ast.SelectionSet, v *db.User) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._User(ctx, sel, v)
